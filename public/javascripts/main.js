...
var pgal = { 
    ...
    init : function () { 
        this.cx   = this.nw / 2; 
        this.cy   = this.nh / 2; 
        this.img  = document.getElementById('messages').getElementsByTagName('div'); 
        this.span  = document.getElementById('messages').getElementsByTagName('span'); 
        this.N    = this.img.length; 
        for (var i = 0; i < this.N; i++) this.O[i] = new this.PGObj(i); 
        this.run(); 
        this.O[this.O.length -1].click(); 
    }, 
    resize : function () { 
    ...
    PGObj : function (n) {
        ...
        this.w                = 400;//pgal.img[n].style.width; 
        this.h                = 100;//pgal.img[n].style.height; 
        ...
        this.anim = function() { 
            ...
            if (f > 0) { 
                ...
                this.obs.fontSize = to_px(1 + d * 40 * pgal.zoom); 
